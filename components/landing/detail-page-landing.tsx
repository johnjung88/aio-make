...
.aiodp2 .hero2{position:relative;overflow:hidden;display:grid;grid-template-columns:1fr;min-height:100vh}
...
.aiodp2 .hero2-txt{position:relative;z-index:2;text-align:center;width:100%}
.aiodp2 .hero2-txt h1,.aiodp2 .hero2-txt p{margin-left:auto;margin-right:auto}
...
.aiodp2 .hero2-bdgs{display:flex;gap:8px;flex-wrap:wrap;margin-bottom:36px;justify-content:center}
...
.aiodp2 .hero2-r{display:none;flex-direction:column;justify-content:center;padding:clamp(80px,10vw,120px) clamp(24px,4vw,56px) clamp(60px,8vw,100px) clamp(16px,3vw,32px);gap:14px;position:relative;z-index:2}
