...
const TEAM: M[] = [
  { av: "리", role: "Planner · 기획", nm: "한리아", career: "기획 8년 · IA/UX 설계", duties: ["사이트 IA·사이트맵·URL 구조 설계", "페이지별 섹션·CTA·문의 전환 흐름 설계", "PC/모바일 반응형 우선순위·기본 SEO 구조 정의"] },
  { av: "준", role: "Copywriter · 카피", nm: "문준", career: "카피 6년 · 브랜드 카피라이터", duties: ["히어로 헤드라인·서브카피·CTA 작성", "섹션별 전환 카피·폼/FAQ 문구 작성", "SEO title·description·OG 문구 작성"] },
  { av: "도", role: "Designer · 디자인", nm: "오도윤", career: "UI/UX 9년 · 웹 디자이너", duties: ["디자인 토큰·컴포넌트 시안 설계", "페이지 시각 위계·그리드·히어로 비율 정의", "히어로/섹션 비주얼 제작·웹 최적화"] },
  { av: "세", role: "Developer · 개발", nm: "정세호", career: "풀스택 10년 · Next.js", duties: ["Next.js·반응형 사이트 구현", "폼·CTA·Supabase·배포·도메인 연동", "빌드·성능·브라우저 호환성 대응"] },
  { av: "현", role: "QA · Ops · 검수운영", nm: "신현아", career: "검수 7년 · 웹 QA·운영", duties: ["반응형·링크·폼·SEO·OG 전수 검수", "배포 전 위험·롤백 포인트 점검", "납품 후 1개월 무상 유지보수"] },
];
