...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    proofType: "screenshots",
    mediaPolicy: "rich-gallery",
    title: { ko: "법무법인 율담 홈페이지", en: "Yuldam Law Firm Website" },
    summary: {
      ko: "기업법무·형사·민사 전담 부티크 법무법인의 신뢰감과 상담 전환을 동시에 잡은 반응형 홈페이지입니다.",
      en: "A responsive website for a boutique law firm specializing in corporate, criminal, and civil cases — built for trust and consultation conversion.",
    },
    problem: {
      ko: "법무법인은 전문성과 신뢰가 첫인상을 결정하지만, 기존 법률 사이트는 정보가 나열식이라 상담 전환으로 이어지기 어렵습니다.",
      en: "Law firms live or die by first impressions of expertise and trust, but most legal sites dump information without guiding visitors toward consultation.",
    },
    solution: {
      ko: "다크 네이비 계열의 무게감 있는 디자인 언어로 전문성을 표현하고, 업무분야·성공사례·변호사 소개 흐름에서 상담 예약 CTA를 자연스럽게 연결합니다.",
      en: "Dark navy design language communicates authority, while a practice areas → case results → attorney bio flow leads naturally into a consultation CTA.",
    },
    impact: {
      ko: "방문자가 법무법인의 전문성을 확인하고 상담 예약까지 이동하는 경로를 명확하게 인식합니다.",
      en: "Visitors can quickly assess the firm's expertise and find a clear path to booking a consultation.",
    },
    deliverables: [
      { ko: "PC·모바일 반응형 홈페이지", en: "Desktop and mobile responsive website" },
      { ko: "업무분야·성공사례·변호사 소개 섹션", en: "Practice areas, case results, and attorney profiles" },
      { ko: "상담 예약 CTA 구조", en: "Consultation booking CTA structure" },
    ],
    stack: ["Next.js", "TypeScript", "Tailwind", "Vercel"],
    role: ["기획", "디자인", "개발", "배포"],
    duration: "3일",
    client: "데모 포트폴리오",
    links: { live: null, github: null, case: "/portfolio/law-yuldam" },
    responsivePreview: {
      desktop: "/portfolio/law-yuldam/live.png",
      mobile: "/portfolio/law-yuldam/mobile-preview.png",
    },
    cover: "/portfolio/law-yuldam/live.png",
    gallery: ["/portfolio/law-yuldam/live.png", "/portfolio/law-yuldam/mobile-preview.png"],
    size: "lg",
    featured: true,
  ...
  },
  {
    ...
    proofType: "screenshots",
    mediaPolicy: "rich-gallery",
    title: { ko: "관세법인 항로 홈페이지", en: "Hangro Customs Corp Website" },
    summary: {
      ko: "수출입 통관·관세환급·FTA 원산지 전문 관세법인의 신뢰와 전문성을 담은 반응형 홈페이지입니다.",
      en: "A responsive website for a customs law firm specializing in import/export clearance, tariff refunds, and FTA origin certification.",
    },
    problem: {
      ko: "관세 서비스는 전문 용어가 많아 처음 방문한 고객이 서비스 범위와 진행 방식을 빠르게 이해하기 어렵습니다.",
      en: "Customs services are jargon-heavy, making it hard for first-time visitors to quickly understand the scope and process.",
    },
    solution: {
      ko: "서비스 흐름을 도식화하고, 통관 속도·환급 실적 등 실증 지표를 전면에 배치해 전문성을 즉시 전달합니다.",
      en: "The service flow is visualized as a diagram, and proof metrics like clearance speed and refund results are placed up front.",
    },
    impact: {
      ko: "방문자는 관세법인의 서비스 범위와 강점을 한눈에 이해하고 문의로 연결됩니다.",
      en: "Visitors understand the firm's scope and strengths at a glance and move into inquiry.",
    },
    deliverables: [
      { ko: "PC·모바일 반응형 홈페이지", en: "Desktop and mobile responsive website" },
      { ko: "서비스 흐름 도식 섹션", en: "Service flow diagram section" },
      { ko: "통관·환급 실적 KPI 섹션", en: "Clearance and refund KPI section" },
    ],
    stack: ["Next.js", "TypeScript", "Tailwind", "Vercel"],
    role: ["기획", "디자인", "개발", "배포"],
    duration: "3일",
    client: "데모 포트폴리오",
    links: { live: null, github: null, case: "/portfolio/cus-hangro" },
    responsivePreview: {
      desktop: "/portfolio/cus-hangro/live.png",
      mobile: "/portfolio/cus-hangro/mobile-preview.png",
    },
    cover: "/portfolio/cus-hangro/live.png",
    gallery: ["/portfolio/cus-hangro/live.png", "/portfolio/cus-hangro/mobile-preview.png"],
    size: "md",
    featured: true,
  ...
  },
  {
    ...
    proofType: "screenshots",
    mediaPolicy: "rich-gallery",
    title: { ko: "NOVATEK 기업 홈페이지", en: "NOVATEK Corporate Website" },
    summary: {
      ko: "정밀 제조와 산업 IT를 결합한 B2B 기업의 글로벌 신뢰감을 담은 반응형 기업 홈페이지입니다.",
      en: "A responsive corporate website for a B2B company combining precision manufacturing and industrial IT.",
    },
    problem: {
      ko: "정밀 제조 B2B 기업은 기술력과 납품 실적을 시각적으로 전달해야 잠재 파트너의 신뢰를 얻기 쉽습니다.",
      en: "Precision manufacturing B2B companies need to communicate technical capability and delivery track record visually to earn partner trust.",
    },
    solution: {
      ko: "다크 계열의 산업적 디자인에 제품·사업 영역·인증 정보를 명확하게 구조화하고, 파트너십 문의 흐름을 간결하게 연결합니다.",
      en: "An industrial dark design structures products, business areas, and certifications clearly, with a streamlined partnership inquiry flow.",
    },
    impact: {
      ko: "잠재 파트너가 기업 역량을 빠르게 파악하고 협업 문의로 연결되는 경로가 명확해집니다.",
      en: "Potential partners can quickly assess the company's capabilities and find a clear path to partnership inquiry.",
    },
    deliverables: [
      { ko: "PC·모바일 기업 홈페이지", en: "Desktop and mobile corporate website" },
      { ko: "제품·사업 영역 소개 섹션", en: "Product and business area sections" },
      { ko: "파트너십 문의 CTA", en: "Partnership inquiry CTA" },
    ],
    stack: ["Next.js", "TypeScript", "Tailwind", "Vercel"],
    role: ["기획", "디자인", "개발", "배포"],
    duration: "3일",
    client: "데모 포트폴리오",
    links: { live: null, github: null, case: "/portfolio/corp-novatek" },
    responsivePreview: {
      desktop: "/portfolio/corp-novatek/live.png",
      mobile: "/portfolio/corp-novatek/mobile-preview.png",
    },
    cover: "/portfolio/corp-novatek/live.png",
    gallery: ["/portfolio/corp-novatek/live.png", "/portfolio/corp-novatek/mobile-preview.png"],
    size: "md",
    featured: false,
  ...
  },
  {
    ...
    proofType: "screenshots",
    mediaPolicy: "rich-gallery",
    title: { ko: "온담 의원 홈페이지", en: "Ondam Clinic Website" },
    summary: {
      ko: "어깨·허리·무릎 비수술 통증치료 전문 의원의 예약 전환과 신뢰 구축에 최적화된 반응형 홈페이지입니다.",
      en: "A responsive website for a non-surgical pain treatment clinic, optimized for appointment conversion and trust building.",
    },
    problem: {
      ko: "통증 의원은 치료 방법·대상 증상·의료진 신뢰를 동시에 전달해야 예약으로 이어지기 쉽습니다.",
      en: "Pain clinics need to convey treatment methods, target symptoms, and physician credibility simultaneously to convert visitors into appointments.",
    },
    solution: {
      ko: "증상별 치료 흐름, 의료진 프로필, 비수술 치료 근거를 단계적으로 보여주고 예약 CTA를 자연스럽게 삽입합니다.",
      en: "Symptom-based treatment flows, physician profiles, and non-surgical evidence are staged progressively, with a natural appointment CTA.",
    },
    impact: {
      ko: "방문자가 자신의 증상과 치료 방식을 연결하고 예약 의사결정을 빠르게 내립니다.",
      en: "Visitors can connect their symptoms to treatment options and make a booking decision quickly.",
    },
    deliverables: [
      { ko: "PC·모바일 병원 홈페이지", en: "Desktop and mobile clinic website" },
      { ko: "증상별 치료 섹션", en: "Symptom-based treatment sections" },
      { ko: "온라인 예약 CTA 구조", en: "Online booking CTA structure" },
    ],
    stack: ["Next.js", "TypeScript", "Tailwind", "Vercel"],
    role: ["기획", "디자인", "개발", "배포"],
    duration: "3-4일",
    client: "데모 포트폴리오",
    links: { live: null, github: null, case: "/portfolio/med-ondam" },
    responsivePreview: {
      desktop: "/portfolio/med-ondam/live.png",
      mobile: "/portfolio/med-ondam/mobile-preview.png",
    },
    cover: "/portfolio/med-ondam/live.png",
    gallery: ["/portfolio/med-ondam/live.png", "/portfolio/med-ondam/mobile-preview.png"],
    size: "lg",
    featured: true,
  ...
  },
  {
    ...
    proofType: "screenshots",
    mediaPolicy: "rich-gallery",
    title: { ko: "세무법인 정산 홈페이지", en: "Jungsan Tax Corp Website" },
    summary: {
      ko: "기장·법인세·종합소득세·상속증여·세무조사 전문 세무법인의 절세 신뢰와 상담 전환을 담은 반응형 홈페이지입니다.",
      en: "A responsive website for a tax law firm specializing in bookkeeping, corporate tax, income tax, inheritance, and tax investigations.",
    },
    problem: {
      ko: "세무 서비스는 절세 효과를 구체적 수치로 보여줘야 상담 전환이 높아지지만, 대부분의 세무 사이트는 서비스 목록 나열에 그칩니다.",
      en: "Tax firms need to show concrete savings numbers to drive consultation conversion, but most tax sites just list services.",
    },
    solution: {
      ko: "절세 시뮬레이터와 실제 절세 사례를 전면에 배치하고, 서비스별 절세 포인트를 구조화해 방문자가 자신의 상황을 빠르게 찾도록 합니다.",
      en: "A tax savings simulator and real case results are placed up front, with per-service savings breakdowns so visitors quickly find their situation.",
    },
    impact: {
      ko: "방문자는 절세 가능성을 수치로 확인하고 상담 문의로 연결되는 명확한 경로를 따릅니다.",
      en: "Visitors see concrete savings potential and follow a clear path to consultation.",
    },
    deliverables: [
      { ko: "PC·모바일 세무법인 홈페이지", en: "Desktop and mobile tax firm website" },
      { ko: "절세 시뮬레이터 섹션", en: "Tax savings simulator section" },
      { ko: "서비스별 절세 포인트 구조", en: "Per-service savings breakdown structure" },
    ],
    stack: ["Next.js", "TypeScript", "Tailwind", "Vercel"],
    role: ["기획", "디자인", "개발", "배포"],
    duration: "3일",
    client: "데모 포트폴리오",
    links: { live: null, github: null, case: "/portfolio/tax-jungsan" },
    responsivePreview: {
      desktop: "/portfolio/tax-jungsan/live.png",
      mobile: "/portfolio/tax-jungsan/mobile-preview.png",
    },
    cover: "/portfolio/tax-jungsan/live.png",
    gallery: ["/portfolio/tax-jungsan/live.png", "/portfolio/tax-jungsan/mobile-preview.png"],
    size: "md",
    featured: true,
  ...
  },
  {
    ...
    proofType: "screenshots",
    mediaPolicy: "rich-gallery",
    title: { ko: "AURA 이어버드 마케팅 랜딩페이지", en: "AURA Earbuds Marketing Landing" },
    summary: {
      ko: "ANC 무선 이어버드 AURA의 제품 감성과 구매 전환 흐름을 담은 다크 테마 마케팅 랜딩페이지입니다.",
      en: "A dark-theme marketing landing page for AURA ANC wireless earbuds, balancing product aesthetics and purchase conversion.",
    },
    problem: {
      ko: "프리미엄 오디오 제품은 기술 스펙보다 소리와 공간 경험을 감각적으로 전달해야 구매 의향이 높아집니다.",
      en: "Premium audio products need sensory storytelling — sound and space experience — more than spec sheets to raise purchase intent.",
    },
    solution: {
      ko: "다크 배경과 공간감 있는 타이포그래피로 몰입감을 만들고, 노이즈캔슬링 기능·배터리·연결성 등 핵심 스펙을 시각적으로 분절해 보여줍니다.",
      en: "Immersion is built with a dark background and spatial typography, while ANC, battery, and connectivity specs are broken into visual segments.",
    },
    impact: {
      ko: "방문자는 제품의 감성적 가치를 먼저 경험하고, 스펙 확인 후 구매 페이지로 자연스럽게 이동합니다.",
      en: "Visitors experience the emotional value first, then check specs, and naturally move toward the purchase page.",
    },
    deliverables: [
      { ko: "PC·모바일 마케팅 랜딩페이지", en: "Desktop and mobile marketing landing page" },
      { ko: "제품 기능 시각화 섹션", en: "Product feature visualization sections" },
      { ko: "구매 CTA 흐름", en: "Purchase CTA flow" },
    ],
    stack: ["Next.js", "TypeScript", "Tailwind", "Vercel"],
    role: ["기획", "디자인", "개발", "배포"],
    duration: "2일",
    client: "데모 포트폴리오",
    links: { live: null, github: null, case: "/portfolio/lp-aura" },
    responsivePreview: {
      desktop: "/portfolio/lp-aura/live.png",
      mobile: "/portfolio/lp-aura/mobile-preview.png",
    },
    cover: "/portfolio/lp-aura/live.png",
    gallery: ["/portfolio/lp-aura/live.png", "/portfolio/lp-aura/mobile-preview.png"],
    size: "md",
    featured: true,
