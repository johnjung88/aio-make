...
export const servicesData: ServiceDetail[] = [
  ...
  },
  {
    ...
    pricing: [
      {
        name: { ko: "10,000PX 이하", en: "Up to 10,000PX" },
        eventPrice: "₩129,000~",
        regularPrice: "₩129,000~",
        duration: "5일 이내",
        includes: [
          { ko: "스토리텔링 + 증거 + 비교 + CTA", en: "Storytelling, proof, comparison, and CTA" },
          { ko: "원본 PSD 제공", en: "PSD source file included" },
          { ko: "수정 무제한", en: "Unlimited revisions" },
        ],
      },
      {
        name: { ko: "20,000PX 이하", en: "Up to 20,000PX" },
        eventPrice: "₩249,000~",
        regularPrice: "₩249,000~",
        duration: "5일 이내",
        recommended: true,
        includes: [
          { ko: "풀 스토리텔링 + Q&A + 후기 + 추천", en: "Full storytelling, Q&A, reviews, and upsell" },
          { ko: "원본 PSD 제공", en: "PSD source file included" },
          { ko: "수정 무제한", en: "Unlimited revisions" },
        ],
      },
    ...
    addons: [
      { name: { ko: "대표 썸네일 제작", en: "Main thumbnail design" }, price: "+₩30,000~" },
      { name: { ko: "AI 연출 이미지 추가", en: "AI-generated product imagery" }, price: "+₩50,000~" },
      { name: { ko: "GIF / 움직이는 요소 제작", en: "GIF / animated elements" }, price: "+₩50,000~" },
    ],
  ...
  },
  {
    ...
    pricing: [
      {
        name: { ko: "디자인 정리형 10P 이하", en: "Design Only · Up to 10P" },
        eventPrice: "₩49,000~",
        regularPrice: "₩49,000~",
        duration: "5일 이내",
        includes: [
          { ko: "기존 자료 정리 / 표지·목차·본문·CTA", en: "Existing content cleanup, cover to CTA" },
          { ko: "PPTX + PDF 납품", en: "PPTX + PDF delivery" },
          { ko: "수정 무제한", en: "Unlimited revisions" },
        ],
      },
      {
        name: { ko: "제안서·회사소개서 20P 이하", en: "Proposal / Company Deck · Up to 20P" },
        eventPrice: "₩99,000~",
        regularPrice: "₩99,000~",
        duration: "5일 이내",
        recommended: true,
        includes: [
          { ko: "기획·스토리텔링 / 그래프·비교·후기", en: "Storytelling, graphs, comparison, reviews" },
          { ko: "PPTX + PDF 납품", en: "PPTX + PDF delivery" },
          { ko: "수정 무제한", en: "Unlimited revisions" },
        ],
      },
      {
        name: { ko: "기획형·IR·사업계획서 30P 이하", en: "IR / Business Plan · Up to 30P" },
        eventPrice: "₩199,000~",
        regularPrice: "₩199,000~",
        duration: "5일 이내",
        includes: [
          { ko: "KPI·로드맵·재무·투자 유치용 풀 구성", en: "KPI, roadmap, financials, investor deck" },
          { ko: "PPTX + PDF 납품", en: "PPTX + PDF delivery" },
          { ko: "수정 무제한", en: "Unlimited revisions" },
        ],
      },
    ...
    addons: [
      { name: { ko: "슬라이드 추가", en: "Extra slide" }, price: "+₩5,000~/장" },
      { name: { ko: "도표 / 인포그래픽 고도화", en: "Diagram / infographic upgrade" }, price: "+₩30,000~" },
      { name: { ko: "빠른 납품 / 급행", en: "Rush delivery" }, price: "+₩50,000~" },
    ],
