    ...
    pricing: [
      {
        ...
        duration: "",
        includes: [
          { ko: "기존 쇼핑몰 구조 복사/이전", en: "기존 쇼핑몰 구조 복사/이전" },
          { ko: "기본 상품 진열 구성", en: "기본 상품 진열 구성" },
          { ko: "모바일 반응형 기본 확인", en: "모바일 반응형 기본 확인" },
          { ko: "수정 1회", en: "수정 1회" },
        ],
      },
      {
        ...
        recommended: true,
        includes: [
          { ko: "메인 구성 + 카테고리/배너 풀세팅", en: "메인 구성 + 카테고리/배너 풀세팅" },
          { ko: "상품 등록 지원", en: "상품 등록 지원" },
          { ko: "모바일 반응형", en: "모바일 반응형" },
          { ko: "기본 SEO 메타 정리", en: "기본 SEO 메타 정리" },
          { ko: "수정 1회", en: "수정 1회" },
        ],
      },
    ],
